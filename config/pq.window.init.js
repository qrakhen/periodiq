...
/**
 * Creates default JSON-configuration-file for electron-browser-window configurations.
 * The new file is stored as periodiq/config/pq.window.json
 * Source for electron-browser-window configurations-object:
...
var WindowConfigs = function() {
    ...
    var configs = {
        ...
        icon: Path.join(__dirname + '/../assets/logo_truescale.png'),
